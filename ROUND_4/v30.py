"""
Round 4 v30 — EXTREME_MAX_TAKE 100→150
=======================================
Base: v29b (524,038 on R4 30k local backtest; 53,689 on official R4 day 3).
...
class Trader:
    ...
    EXTREME_MAX_TAKE = 150   # v30: raised from 100; v_over (200) gap vs v29b: 5000=+4.2k, 5100=+3.8k, 5200=+3.0k
