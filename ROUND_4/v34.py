"""
Round 4 v34 — Mark 14 in overlay + VEV_5200 overlay + VEV_5500 BUY_MAX fix
============================================================================
Base: v33 (473,881 local).

Fresh bot analysis on Round 4 trade data (all 4,281 trades across 3 days):

OVERLAY EXPANSION — add Mark 14 as a second overlay buyer:
  Mark 14 is a profitable market-maker (+420k PnL) who also buys OTM VEVs:
  VEV_5300: 105 units at p50=42, p75=47, p90=50, max=53
  VEV_5400:  48 units at p50=15, p75=20, p90=20, max=21
  VEV_5500:  27 units at p50=7,  p75=7,  p90=7,  max=7
  VEV_5200: 122 units at p50=79, p75=83, p90=88, max=98

  Combined M01+M14 demand at existing floors:
  VEV_5300 ≥47: 98  total (M01:63,  M14:35)  vs v33's 63 (+56%)
  VEV_5400 ≥15: 258 total (M01:230, M14:28)  vs v33's 230 (+12%)
  VEV_5500 ≥5:  466 total (M01:449, M14:17)  vs v33's 449 (+4%)

NEW VEV_5200 OVERLAY (floor=70):
  Mark 14 buys 122 VEV_5200 units at prices 52-98; p50=79, p75=83.
  Mark 01 buys  34 VEV_5200 units at prices 52-77; p50=68.
  Combined demand ≥70: 112 units (M01:11, M14:101). Mark 14 dominates.
  Expected: sell ~15 units/day @ avg 80 to bots buying at 70-98.

VEV_5500 BUY_MAX FIX (4 → 3):
  Mark 22 asks ≤3: 479 units available to buy
  M01+M14 bids ≥5: 466 units available to sell
  BUY_MAX=4 created imbalance (603 buy vs 466 sell) → stuck long at +300 locally.
  BUY_MAX=3 makes buy/sell nearly balanced: 479 vs 466.

Changes from v33
────────────────
1. OVERLAY_BUYER_IDS: {"Mark 01"} → {"Mark 01", "Mark 14"}
2. MARK01_MIN_BID["VEV_5200"]: new entry at 70
3. VEV_5500_BUY_MAX: 4 → 3  [balances buy/sell, fixes stuck long]
...
class Trader:
    ...
    VEV_5500_BUY_MAX  = 3   # v34: 4→3 (Mark 22 asks ≤3: 479 units ≈ M01+M14 bids ≥5: 466; balanced)
    VEV_5500_SELL_MIN = 5   # v33: 7→5 (Mark 01 bids ≥5 on 449 units; official max bid was 6)
    ...
    MARK01_MIN_BID: Dict[str, int] = {
        ...
        "VEV_5300":  47,   # v33: 53→47 (combined M01+M14 at ≥47: 98 units, +56% vs M01-only)
        "VEV_5400":  15,   # v33: 19→15 (combined M01+M14 at ≥15: 258 units)
