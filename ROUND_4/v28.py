"""
Round 4 v28 — VEV_5500 SELL_MIN 7→6, VEV_5100/5200 caps 150→200
=================================================================
Base: v27 (509,669 on R4 30k local backtest; 43,697 on official R4 day 3).

Changes from v27
────────────────
1. VEV_5500_SELL_MIN: UNCHANGED at 7
   SLURM sweep on v28 base confirmed 7 is optimal:
     SELL_MIN=4: 454,477 | 5: 534,012 | 6: 535,920 | 7: 536,621 ← | 8: 535,557
   BUY_MAX stays at 4 (v27 calibration).

2. EXTREME_CAPS[VEV_5100]: 150 → 200
   EXTREME_CAPS[VEV_5200]: 150 → 200
   Official day 3: VEV_5100=+5,291 and VEV_5200=+5,360 at cap=150.
   v17 used cap=200 and generated more PnL (5100=+7,235, 5200=+5,126).
   Thresholds are well-calibrated (BUY=153/85 fires ~27% of official ticks).
   Cap sweep (R4 local): cap=150→554,809; cap=200→581,761 (+27k).
   Tail risk is limited as BUY thresholds are conservative (10pts below mean).

Retained from v27:
   HYDROGEL EXTREME_SELL=10,050  |  VEV_5500 BUY_MAX=4  |  Mark01 overlay  |  TV unchanged
