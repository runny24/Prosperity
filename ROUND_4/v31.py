...
class Trader:
    ...
    EXTREME_SELL: Dict[str, int] = {
        ...
        "VEV_5100":               181,
        "VEV_5200":               106,
        "VEV_5300":                53,   # unchanged: 53→50 hurt -11.5k locally (premature sells)
        "VEV_5400":                19,
    ...
    VEV_5500_BUY_MAX  = 0   # v31: was 4; disabled — consistent -384 confirmed
    VEV_5500_SELL_MIN = 7   # sweep-confirmed optimum (kept in case bids spike)
