...
class Trader:
    ...
    Changes from v1:
    - Keep the spot strategies for HYDROGEL_PACK and VELVETFRUIT_EXTRACT.
    - Disable all passive voucher quotes.
    - Trade vouchers only when visible liquidity is clearly mispriced.
    - Add voucher soft caps below the official position limits.
    - Disable VEV_4000, VEV_4500, VEV_6000, and VEV_6500 for now.
    """
