...
class Trader:
    """
    Round 3 v5_tte6: TTE-aware option-model candidate for platform tests.
    ...
    Platform public tests appear to replay historical day 2, where TTE is 6.
    Final Round 3 should use TTE=5 instead.
    """
