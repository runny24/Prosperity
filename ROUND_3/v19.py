"""
Round 3 v19 — VEV_5500_SELL_MIN bug fix (8 → 6)
=================================================
...
Single change from v17: VEV_5500_SELL_MIN 8 → 6.

Analysis from 461960.log (1000-tick market data):
──────────────────────────────────────────────────
VEV_5500 bid distribution: min=4, p25=5, p50=6, p75=6, max=7.
Max observed bid is 7 — SELL_MIN=8 fires 0/1000 ticks (dead threshold).
SELL_MIN=6 fires 663/1000 (66.3%) of ticks.
SELL_MIN=7 fires 111/1000 (11.1%) of ticks.

With SELL_MIN=8: buy at ask≤5 (1.6% of ticks), can NEVER unwind.
  → Mark-to-market PnL of 445 is unrealized and accumulates dead longs.
With SELL_MIN=6: buy at ask≤5, sell at bid≥6 — proper cycling.
  → ~1pt gain per unit per cycle.

All other v17 parameters confirmed well-calibrated:
• Extreme thresholds: 7-13% trigger rates on all products ✓
• Autocorrelations: mean-reverting (-0.055 to -0.172) ✓ validates EMA
• EMA alphas: 0.08/0.12 appropriate for respective reversion speeds ✓
• MAKE_EDGE: 5/2 — active inventory management role ✓
• VEV_4000/4500 fixed absolute thresholds retained (dynamic version in v18
  cost -4,789 PnL due to EMA lag — do not use that branch)
