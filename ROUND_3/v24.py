"""
Round 3 v24 — VEV_5500 SELL_MIN 8 → 7
=========================================
v23 30k PnL: 531,191

Single change from v23: VEV_5500_SELL_MIN 8 → 7

Rationale:
  30k bid distribution for VEV_5500:
    bid≥8 (old SELL_MIN): 18.4% of ticks (5,514 opportunities)
    bid≥7 (new SELL_MIN): 41.7% of ticks (12,520 opportunities)
  Lowering to 7 gives 2.27× more sell opportunities.
  Per-cycle net drops from ≥3pts (buy≤5, sell≥8) to ≥2pts (buy≤5, sell≥7),
  but faster inventory turnover should more than compensate.
  VEV_5500 earned only 3,348 on 30k with SELL_MIN=8; expect meaningful gain.
...
class Trader:
    ...
    VEV_5500_BUY_MAX  = 5
    VEV_5500_SELL_MIN = 7   # v24: lowered from 8→7; fires 41.7% on 30k (was 18.4%); 2.27× more sell ops
