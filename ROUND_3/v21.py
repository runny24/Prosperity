"""
Round 3 v21 — 30k-dataset extreme threshold recalibration
==========================================================
v17 test PnL (1k ticks): 44,264
v17 per-tick rate: 44.3 PnL/tick

30k dataset analysis (3 days × 10k ticks, same environment as competition):
  Day 0: 131,808  Day 1: 325,694  Day 2: 463,802  Total: 921,304
  Per-tick rate: 30.7 PnL/tick  (31% below v17 per-tick — thresholds miscalibrated)

Root cause: velvetfruit mean shifted from 5262 (1k) to 5248 (30k), dragging all
VEV intrinsics down ~14 pts. v17 buy thresholds, calibrated to the 1k subset,
now fire at normal-market prices rather than true extremes:

  Product              v17_buy  fires_30k  v21_buy  fires_30k
  VELVETFRUIT          5255     58.0%  →   5233     10.4%
  VEV_4000             1255     40.5%  →   1241     10.7%
  VEV_4500              755     46.4%  →    738     10.1%
  VEV_5000              258     52.6%  →    240     10.3%
  VEV_5100              165     39.3%  →    153     10.7%
  VEV_5200               93     34.6%  →     85     11.6%
  VEV_5300               47     44.6%  →     39     10.3%
  VEV_5400               14     25.9%  →     12     13.5%

Sell-side recalibrations (smaller adjustments):
  HYDROGEL SELL: 10012→10022 (17.9%→10.3%); HYDROGEL BUY: 9948→9956 (5.7%→10.3%)
  VEV_4000 SELL: 1269→1261 (2.4%→10.2%); VEV_4500 SELL: 769→763 (3.9%→10.9%)
  VEV_5400 SELL: 18→19 (23.9%→15.6%)

VEV_5500 SELL_MIN: confirmed 8 (fires 18.4% on 30k; was 0% on 1k subset — that
  was an unusually quiet day). BUY_MAX=5 fires 19.6% on 30k. Good cycling pair.
...
class Trader:
    ...
    EXTREME_SELL: Dict[str, int] = {
        "HYDROGEL_PACK":       10_022,   # 30k recal: 10.3% (was 10012 → 17.9%)
