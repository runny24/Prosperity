...
Round 5 v3
==========
Robustness correction after reading the submitted r5_v2 log.

The official/log result for v2 was slightly below the old baseline because v2
removed three products that were positive in the official run. v3 restores the
original online-validated EMA roster and keeps only the standalone snack alpha
that improved both the local harness and the v2 official log.
