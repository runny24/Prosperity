...
Round 5 v4
==========
v3 plus a controlled increase in the standalone snack alpha.

The submitted v3 log reached 32.7k and showed all three snack names positive.
Local full-day sweeps also improved when the snack limit was raised from 4 to 8:
the worst full-day replay rose above 60k and drawdown improved versus v3.
...
- snack limit increased from 4 to 8
"""
