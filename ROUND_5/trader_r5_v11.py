"""
Round 5 v11 — Add 3 Consistent-Trend Products
==============================================
Based on v10. Adds products with consistent directional drift across all 3 days:

  UV_VISOR_AMBER:       D2=-1500 D3=-1109 D4=-255 (consistent DOWN, clean D2/D3)
  MICROCHIP_OVAL:       D2=-744  D3=-1824 D4=-1898 (consistent DOWN, clean D3/D4)
  OXYGEN_SHAKE_GARLIC:  D2=+1828 D3=+111  D4=+1958 (consistent UP, clean D2/D4)

Tuned slow_alpha per product based on trend speed.
Circuit breaker provides protection on noisy days.
"""
...
class Trader:
    ...
    # ── Whitelist: v10 products + 3 new consistent-trend products ────────
    WHITELIST = {
        # v10 products
        "PEBBLES_XL",                    # constraint arb  +81,035
        "OXYGEN_SHAKE_MORNING_BREATH",   # EMA trend       +18,170
        "ROBOT_MOPPING",                 # EMA trend       +16,374
        "MICROCHIP_CIRCLE",              # EMA trend       +15,561
        "SLEEP_POD_COTTON",              # EMA trend       +10,050
        "GALAXY_SOUNDS_BLACK_HOLES",     # EMA trend       +10,027
        "GALAXY_SOUNDS_PLANETARY_RINGS", # EMA trend       +11,981
        # New consistent-trend products (all 3 days same direction)
        "UV_VISOR_AMBER",                # EMA trend DOWN  (consistent -1500, -1109, -255)
        "MICROCHIP_OVAL",                # EMA trend DOWN  (consistent -744, -1824, -1898)
        "OXYGEN_SHAKE_GARLIC",           # EMA trend UP    (consistent +1828, +111, +1958)
    }
    ...
    SLOW_ALPHA_OVERRIDE: Dict[str, float] = {
        ...
        # New products
        "UV_VISOR_AMBER":                0.0008,  # moderate trend speed
        "MICROCHIP_OVAL":                0.0006,  # fast sustained decline
        "OXYGEN_SHAKE_GARLIC":           0.002,   # similar to OXYGEN_SHAKE_MORNING_BREATH
    }
