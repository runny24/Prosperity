"""
Round 5 v10 — Expanded with Consistent Products
=================================================
Based on v5 but adds products that showed positive on ALL 3 days in analysis.

Inaccurate results, please use backtester
Products positive on ALL 3 days (from analysis):
  - GALAXY_SOUNDS_PLANETARY_RINGS: D2=173,951 D3=84,607 D4=200,966 = 459,524
  - UV_VISOR_YELLOW: D2=73,381 D3=185,438 D4=150,079 = 408,898

These are added with conservative position limits to avoid overfitting.
"""
...
class Trader:
    ...
    # ── Expanded Whitelist: v5 products + 1 consistent product ───────────
    WHITELIST = {
        # Original v5 products
        ...
        # New consistent product (positive all 3 days)
        "GALAXY_SOUNDS_PLANETARY_RINGS", # EMA trend       (consistent)
    }
