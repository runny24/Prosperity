"""
Round 5 v14 — First-1000-tick sweep additions
==============================================
Built on v13 (28,452 online). Added 4 ALL_POS products (positive in D2/D3/D4
first-1000-tick sweep). Removed 2 consistently-negative products.

Removed vs v13 (consistently negative in first-1000-tick across all days):
  GALAXY_SOUNDS_BLACK_HOLES  (online -104, D3=-1570, sweep avg≈-145)
  MICROCHIP_OVAL             (online -503, D2=-1374, D3=-1034, sweep avg≈-616)

Added (ALL_POS: positive in D2/D3/D4 first-1000-tick sweep):
  UV_VISOR_RED        α=0.003  D2=+3619 D3=+982  D4=+3798 avg=+2800
  ROBOT_VACUUMING     α=0.0006 D2=+1186 D3=+2180 D4=+1135 avg=+1500
  MICROCHIP_TRIANGLE  α=0.003  D2=+106  D3=+2391 D4=+692  avg=+1063
  OXYGEN_SHAKE_GARLIC α=0.005  D2=+462  D3=+363  D4=+673  avg=+500
"""
...
class Trader:
    ...
    WHITELIST = {
        ...
        "PEBBLES_XL",
        # EMA trend products — validated online or ALL_POS in 1000-tick sweep
        "OXYGEN_SHAKE_MORNING_BREATH",   # α=0.002  | online +799
        "ROBOT_MOPPING",                 # α=0.0006 | online +2012
        "MICROCHIP_CIRCLE",              # α=0.0006 | online -730  (3-day ALL_POS sweep)
        ...
        # New additions: ALL_POS in D2/D3/D4 first-1000-tick sweep
        "UV_VISOR_RED",                  # α=0.003  | sweep D2=+3619 D3=+982  D4=+3798
