"""
Round 5 v16 — 2/3-day additions to close the 55.5k gap
========================================================
Built on v15 (D4≈53k). Added 2 more 2/3-positive products.

Added vs v15 (2/3 days positive in first-1000-tick sweep):
  TRANSLATOR_ECLIPSE_CHARCOAL  α=0.004  D2=+1030 D3=-2085 D4=+1595  (D2+D4 pos)
  PANEL_1X2                    α=0.010  D2=-580  D3=+1580 D4=+1062  (D3+D4 pos)
"""
...
class Trader:
    ...
    WHITELIST = {
        ...
        "TRANSLATOR_ECLIPSE_CHARCOAL",   # α=0.004  | sweep D2=+1030 D3=-2085 D4=+1595
        "PANEL_1X2",                     # α=0.010  | sweep D2=-580  D3=+1580 D4=+1062
    }
    ...
    SLOW_ALPHA_OVERRIDE: Dict[str, float] = {
        ...
        "TRANSLATOR_ECLIPSE_CHARCOAL":   0.004,
        "PANEL_1X2":                     0.010,
    }
