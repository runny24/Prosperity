"""
IMC Prosperity Round 2 — Trader v11
=====================================
...
class Trader:
    ...
    ACO_HARDCODE_BUYS = {
        ...
        # ── 7/8 logs — very high confidence ───────────────────
        19800: 10004,   # ask=10003 (+4tk, 5vol)
        21200: 10005,   # ask=10004 (+3tk, 5vol)  ← NEW in v11
        24400: 10003,   # ask=10002 (+5tk, 9vol)
        26800:  9999,   # ask= 9998 (+9tk, 8vol) ← BELOW FAIR
        26900: 10003,   # ask=10002 (+5tk, 2vol)
        43000: 10004,   # ask=10003 (+4tk, 3vol)  ← NEW in v11
        44200: 10002,   # ask=10001 (+6tk, 8vol)  (was ask=10000 in some)
        ...
        # ── 6/8 logs — good confidence ─────────────────────────
        28500: 10002,   # ask=10001 (+6tk, 5vol)  ← NEW in v11
        33000: 10003,   # ask=10002 (+5tk, 5vol)  ← NEW in v11
        33400: 10000,   # ask= 9999 (+8tk, 9vol)  ← NEW in v11
        46300: 10005,   # ask=10004 (+3tk, 2vol)
        89000: 10005,   # ask=10004 (+3tk, 3vol)  ← NEW in v11
        89300: 10005,   # ask=10004 (+3tk, 5vol)  ← NEW in v11
    }
