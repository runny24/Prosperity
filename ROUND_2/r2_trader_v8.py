"""
IMC Prosperity Round 2 — Trader v8
====================================
...
v8 (this file) — REVERT TO v6 EXACTLY
  - ACO: fully restored to v6 / v3 passive sell logic (best_ask-1 ≈ FAIR+9)
  - Everything else identical to v6 (bid()=200, CONV_MIN_EDGE=0.5, etc.)
